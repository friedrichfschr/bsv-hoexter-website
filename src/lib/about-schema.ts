...
export const defaultAboutContent = aboutContentSchema.parse({
  ...
  bdks: [{
    ...
    summary: "Auf der ersten Bezirksdelegiertenkonferenz wurde über die Ziele und Satzung der neuen BSV beraten und der erste Bezirksvorstand sowie die ersten Landesdelegierten gewählt. Seitdem arbeitet die BSV Höxter für die Interessen der Schüler*innen im Kreis Höxter und entwickelt Ideen für die Zukunft der Schülerschaft im Kreis Höxter.",
    documentIds: ["gruendungs-bdk-einladungen-2026", "gruendungs-bdk-tagesordnung-2026"],
